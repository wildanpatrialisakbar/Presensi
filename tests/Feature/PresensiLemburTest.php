...
class PresensiLemburTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $response = $this->postJson(route('v1.presensi.lembur'));

        $response->assertUnauthorized();
    }

    public function test_presensi_lembur()
    {
    ...
    public function test_tidak_bisa_presensi_lembur_karena_bukan_waktu_presensi_lembur()
    {
        Sanctum::actingAs($this->pegawai);
